      ...
      <header>
				...
				<nav className="limiter-menu-desktop container">
					...
					<div className="menu-desktop">
						<ul className="main-menu">
							<li className="">
								<NavLink className='nav-bar-link' style={navStyle} to='/'>Home</NavLink>
							...
							<li>
								<NavLink className='nav-bar-link' style={navStyle} to='/about'>About</NavLink>
							</li>
							...
							<li>
								<NavLink className='nav-bar-link' style={navStyle} to='/admin'>Admin</NavLink>
							</li>
						</ul>
					</div>	
		...
		<div className="wrap-header-mobile">
			...
			<div className="logo-mobile">
				<a href=""><img src={Logo1} alt="IMG-LOGO"/></a>
			</div>
